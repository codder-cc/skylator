...
class FakeAgent:
    ...
    # NB: a small positive timeout — the host dequeue treats timeout=0 as "already expired".
    ...
    def step(self, timeout=0.5) -> bool:
    ...
    def drain(self, max_steps=1000) -> int:
        ...
        n = 0
        while n < max_steps and self.step(timeout=0.5):
            n += 1
        return n

    def step_no_ack(self, timeout=0.5):
