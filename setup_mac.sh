...
echo ""
echo "First run will download the model (~20 GB MLX 4-bit) from HuggingFace."
echo "Model: mlx-community/Huihui-Qwen3.5-35B-A3B-Claude-4.6-Opus-abliterated-4bit"
