...
echo Building llama-cpp-python from source for RTX 5080 (sm_120)...

H:\Nolvus\Translator\venv\Scripts\pip install llama-cpp-python --upgrade --no-binary :all: --force-reinstall
